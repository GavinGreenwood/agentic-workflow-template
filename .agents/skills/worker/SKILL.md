---
name: worker
description: Complete well-scoped, low-judgement repository work such as searches, mechanical edits, log checks, file gathering, and routine lookups.
---
...
- Ground everything in the real files using the runtime's file, search, and shell tools.
...
Follow this project's contract in `AGENTS.md`. Do not edit files unless the
