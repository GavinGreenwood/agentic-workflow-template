---
name: advisor
description: Give a grounded second opinion on consequential design choices, risky refactors, ambiguous tradeoffs, or blocked implementation work. Advise without editing.
---
