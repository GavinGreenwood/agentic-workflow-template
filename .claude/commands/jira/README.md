...
| `TEMPO_ACCOUNT_ID` | Your Atlassian account ID (find it at id.atlassian.com or Jira profile URL)   |
| `GIT_AUTHOR_NAME`  | Your git author name as it appears in commits — filters log to your work only |
